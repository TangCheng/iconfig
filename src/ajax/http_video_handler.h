...
#define IPCAM_HTTP_VIDEO_HANDLER(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), IPCAM_HTTP_VIDEO_HANDLER_TYPE, IpcamHttposdHandler))
#define IPCAM_HTTP_VIDEO_HANDLER_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), IPCAM_HTTP_VIDEO_HANDLER_TYPE, IpcamHttposdHandlerClass))
...
#define IPCAM_HTTP_VIDEO_HANDLER_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), IPCAM_HTTP_VIDEO_HANDLER_TYPE, IpcamHttposdHandlerClass))
